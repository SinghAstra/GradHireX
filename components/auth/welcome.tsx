...
import { EMAIL_VERIFICATION_LINK_RESEND_TIME } from "@/lib/constant/auth.constant";
...
const CountdownButton = () => {
  ...
  const resentTime = EMAIL_VERIFICATION_LINK_RESEND_TIME;
